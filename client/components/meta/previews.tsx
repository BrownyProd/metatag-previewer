  ...
  return (
    <Panel>
      <div className="space-y-1 p-4">
        <div className="text-[#1a0dab] dark:text-[#8ab4f8] text-xl leading-6 hover:underline cursor-default">
          {title}
        </div>
        <div className="text-[#006621] dark:text-emerald-300 text-sm">
          {display}
        </div>
    ...
    <Panel>
      <div className="flex gap-4 p-4">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-1 text-sm text-foreground/70 overflow-hidden">
            {desc}
          </div>
